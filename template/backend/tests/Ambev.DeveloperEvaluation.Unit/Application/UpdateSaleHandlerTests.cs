...
public class UpdateSaleHandlerTests
{
    ...
    public UpdateSaleHandlerTests()
    {
        ...
        _handler = new UpdateSaleHandler(_saleRepository, _mapper, _bus, _cache);
    ...
    /// <summary>
    /// Tests that updating a sale invalidates the Sales list cache.
    /// </summary>
    [Fact(DisplayName = "Given existing sale When updated Then invalidates the sales list cache")]
